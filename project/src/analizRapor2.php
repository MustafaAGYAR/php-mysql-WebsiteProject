...
ORDER BY personel.dagitimHiz ASC
LIMIT 3");
$handle->execute();
...
<html lang="tr">
    ...
    <body>
        <div id="container">
            ...
            <section id="content2">
            <div id="chartContainer7" style="height: 160px; width: 50%; margin-top: 150px; float:left; margin-left:350px;"></div>

            <button style=" width:100px; margin-top:360px;  background-color:black; color: white;" id="sonuc5">Önerilen</button>
            <script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
            <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
            <script type="text/javascript">

                        $("#sonuc5").click(function(){
                            // swal("İstikrarlı İlerleme!", "Yeni Şube Açma Yakındır!", "info")
                            swal({
                            title: "En Başarısız Elamanlarımız!",

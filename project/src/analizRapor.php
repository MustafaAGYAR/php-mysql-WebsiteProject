...
$gelenveri = $_POST['subeler'];

if($gelenveri== 'Buca Analiz Raporu'){
   
}

else if($gelenveri== 'Bornova Analiz Raporu'){
    Header("Location:bornova.php");
}

else if($gelenveri== 'Konak Analiz Raporu'){
    Header("Location:konak.php");
}

else if($gelenveri== 'Urla Analiz Raporu'){
    Header("Location:urla.php");
}
...
<html lang="tr">
    <head>
        ...
        window.onload = function () {
            ...
            title:{
            text: "Buca Şubesi en fazla Dağıtım Sağlanan 3 AY"
            },
            data: [{
    ...
    <body>
        <div id="container">
            ...
            <section id="content2">
            <div id="chartContainer5" style="height: 200px; width: 50%; margin-top: 150px; float:left; margin-left:350px;"></div>

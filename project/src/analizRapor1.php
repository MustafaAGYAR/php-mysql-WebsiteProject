...
ORDER BY personel.dagitimHiz DESC
LIMIT 3"
);
$handle->execute();
...
<html lang="tr">
    ...
    <body>
        <div id="container">
            ...
            <button style=" width:100px; margin-top:360px;  background-color:black; color: white;" id="sonuc4">Önerilen</button>
            <script src="https://code.jquery.com/jquery-3.6.0.js" integrity="sha256-H+K7U5CnXl1h5ywQfKtSj8PCmoN9aaq30gDh27Xc0jk=" crossorigin="anonymous"></script>
            <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
            <script type="text/javascript">

                        $("#sonuc4").click(function(){
                            
                            swal({
                            title: "En başarılı Elamanlarımız!",
